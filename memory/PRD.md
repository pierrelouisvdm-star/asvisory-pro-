...
- [x] **Individual vs Financial Advisor workspace split** — role chosen at signup (locked in), existing users see RoleSelectionModal on next login, dashboard renders advisor-only "Advisor Workflow" section, /report-builder route gated to advisors, dual hero CTAs on landing page, dual pricing (Individual R299/R1499, Advisor R999/R6999). Verified 11/11 backend pytest + frontend role flows.

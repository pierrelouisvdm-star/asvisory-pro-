...
const usCalculators = [
  ...
  // Batch 2 — Newly routed
  {
    ...
    description: 'Short vs long-term rates, NIIT, and state taxes for all 50 states',
    icon: TrendingDown,
    path: '/us/capital-gains',
    features: ['LTCG/STCG Rates', 'NIIT 3.8%', 'All 50 States'],
    isFree: false,
    isNew: true,
  },
  {
  ...
  {
    id: 'us-roth-conversion',
    title: 'Roth Conversion Analyzer',
    description: 'Should you convert? Break-even analysis with future tax rates',
    icon: RefreshCcw,
    path: '/us/roth-conversion',
    features: ['Break-Even', 'Tax Cost Now', 'RMD Reduction'],
    isFree: false,
    isNew: true,
  },
  {
    ...
    description: 'Exact take-home pay after federal, state, FICA & pre-tax deductions',
    icon: Briefcase,
    path: '/us/paycheck',
    features: ['FICA Taxes', 'Pre-Tax Ded.', 'All 50 States'],
    isFree: false,
    isNew: true,
    isFeatured: true,
  },
  // Tier 1 — High value
  {
    ...
    description: 'Check if your income triggers Medicare premium surcharges',
    icon: HeartPulse,
    path: '/us/irmaa',
    features: ['Part B & D', 'All IRMAA Tiers', 'Appeal Tips'],
    isFree: false,
    isNew: true,
  },
  {
    id: 'us-w4',
    title: 'W-4 Withholding Optimizer',
    description: 'Tune your W-4 to avoid owing or getting an unnecessary refund',
    icon: ClipboardList,
    path: '/us/w4-optimizer',
    features: ['W-4 Step 3/4', 'Bracket Room', 'Per-Paycheck Fix'],
    isFree: false,
    isNew: true,
    isFeatured: true,
  },
  ...
  },
  {
    ...
    description: 'True cost comparison with appreciation, taxes & opportunity cost',
    icon: Building2,
    path: '/us/rent-vs-buy',
    features: ['Break-Even Year', 'Net Cost', 'Opportunity Cost'],
    isFree: false,
    isNew: true,
    isFeatured: true,
  },
  ...
  // Tier 2
  {
    ...
    description: 'Estimate your Marketplace Premium Tax Credit',
    icon: Activity,
    path: '/us/aca-subsidy',
    features: ['PTC Estimate', 'Medicaid Check', 'FPL Calculator'],
    isFree: false,
    isNew: true,
  },
  {
    ...
    description: 'After-tax 401(k) contributions → Roth conversion explained',
    icon: PiggyBank,
    path: '/us/mega-backdoor-roth',
    features: ['$69k Limit', 'After-Tax Space', 'Step-by-Step'],
    isFree: false,
    isNew: true,
  },
  {
    id: 'us-freelancer-rate',
    title: 'Freelancer Rate Calculator',
    description: 'What hourly rate do you need to hit your income goal as 1099?',
    icon: DollarSign,
    path: '/us/freelancer-rate',
    features: ['SE Tax', 'Benefits Cost', 'W-2 Match Rate'],
    isFree: false,
    isNew: true,
  },
  {
  ...
  // Tier 3 — Engagement & content
  {
    id: 'us-fi-score',
    title: 'FI Score Quiz',
    description: 'Score your financial independence progress in 6 questions',
    icon: Award,
    path: '/us/fi-score',
    features: ['6 Categories', 'Shareable Score', 'Action Plan'],
    isFree: true,
    isNew: true,
    isFeatured: true,
  },
  {
    id: 'us-tax-calendar',
    title: 'US Tax Calendar',
    description: '2025–2026 tax deadlines, contribution limits & year-end actions',
    icon: CalendarDays,
    path: '/us/tax-calendar',
    features: ['Estimated Taxes', 'IRA/HSA Dates', '2025 Limits'],
    isFree: true,
    isNew: true,
  },
  {

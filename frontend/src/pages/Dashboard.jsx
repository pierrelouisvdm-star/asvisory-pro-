...
const advisorTools = [
  ...
  {
    id: 'portfolio-review',
    title: 'Multi-Document Portfolio Review',
    description: 'Aggregate 3+ client docs (RA, TFSA, endowment, life cover) into one consolidated AI view',
    icon: Layers,
    path: '/portfolio-review',
    features: ['Fee Audit', 'Diversification', 'Outdated Product Flags'],
    isFree: false,
    isNew: true,
    isFeatured: true,
  },

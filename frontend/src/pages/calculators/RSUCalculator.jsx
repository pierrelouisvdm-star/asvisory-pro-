...
const LTCG_BRACKETS_SINGLE = [
  { max: 48350, rate: 0.00 }, { max: 533400, rate: 0.15 }, { max: Infinity, rate: 0.20 },
];
const LTCG_BRACKETS_MFJ = [
  { max: 96700, rate: 0.00 }, { max: 600050, rate: 0.15 }, { max: Infinity, rate: 0.20 },
];

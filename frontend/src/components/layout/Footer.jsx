      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-900 dark:text-white">Secure</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Bank-level security</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-50 dark:bg-emerald-900/20">
            ...
            <div>
              <p className="text-sm font-medium text-slate-900 dark:text-white">Certified</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Industry standard</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-50 dark:bg-emerald-900/20">
            ...
            <div>
              <p className="text-sm font-medium text-slate-900 dark:text-white">Accurate</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Precise calculations</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-50 dark:bg-emerald-900/20">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">Instant results</p>
            </div>
          </div>
        </div>

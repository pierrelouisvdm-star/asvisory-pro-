...
export const PrintReport = ({ 
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
        <head>
          <title>${title} - WealthCalc Report</title>
          <style>
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-auto">
        ...
        >
          ...
          <p className="subtitle text-muted-foreground mb-6">
            Professional calculation prepared using WealthCalc Financial Advisor Suite
          </p>
          ...
          <div className="footer mt-6 pt-4 border-t border-border text-center text-xs text-muted-foreground">
            <p>Generated by WealthCalc Financial Advisor Suite</p>
            <p>© {new Date().getFullYear()} WealthCalc. All rights reserved.</p>
          </div>
        </div>

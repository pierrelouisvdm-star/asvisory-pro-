...
export const PrintReport = ({ 
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
        <head>
          <title>${title} - Financial Advisory Pro Report</title>
          <style>
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-auto">
        ...
        >
          ...
          <div className="footer mt-6 pt-4 border-t border-border text-center text-xs text-muted-foreground">
            <p>Generated by Financial Advisory Pro Suite</p>
            <p>© {new Date().getFullYear()} Financial Advisory Pro. All rights reserved.</p>
          </div>
        </div>
